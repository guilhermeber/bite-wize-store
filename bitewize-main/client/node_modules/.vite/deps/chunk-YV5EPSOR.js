...
var AngleUpIcon = React.memo(React.forwardRef(function(inProps, ref) {
...
var InputNumber = React2.memo(React2.forwardRef(function(inProps, ref) {
  ...
  var timer = React2.useRef(null);
  var lastValue = React2.useRef(null);
  var numberFormat = React2.useRef(null);
  var groupChar = React2.useRef(null);
  var prefixChar = React2.useRef(null);
  var suffixChar = React2.useRef(null);
  var isSpecialChar = React2.useRef(null);
  var _numeral = React2.useRef(null);
  var _group = React2.useRef(null);
  var _minusSign = React2.useRef(null);
  var _currency = React2.useRef(null);
  var _decimal = React2.useRef(null);
  var _decimalSeparator = React2.useRef(null);
  var _suffix = React2.useRef(null);
  var _prefix = React2.useRef(null);
  var _index = React2.useRef(null);
  var isFocusedByClick = React2.useRef(false);
  ...
  var createInputElement = function createInputElement2() {
    ...
    return React2.createElement(InputText, _extends2({
      ref: inputRef,
      id: props.inputId,
  ...
  var createUpButton = function createUpButton2() {
    ...
    var icon = props.incrementButtonIcon || React2.createElement(AngleUpIcon, incrementIconProps);
    ...
    return React2.createElement("button", incrementButtonProps, upButton, React2.createElement(Ripple, null));
  };
  var createDownButton = function createDownButton2() {
    var decrementIconProps = mergeProps({
      className: cx("decrementIcon")
    }, ptm("decrementIcon"));
    var icon = props.decrementButtonIcon || React2.createElement(AngleDownIcon, decrementIconProps);
    ...
    return React2.createElement("button", decrementButtonProps, downButton, React2.createElement(Ripple, null));
  };
  var createButtonGroup = function createButtonGroup2() {
    ...
    if (stacked) {
      return React2.createElement("span", buttonGroupProps, upButton, downButton);
    }
    return React2.createElement(React2.Fragment, null, upButton, downButton);
  };
  ...
  return React2.createElement(React2.Fragment, null, React2.createElement("span", _extends2({
    ref: elementRef
  }, rootProps), inputElement, buttonGroup), hasTooltip && React2.createElement(Tooltip, _extends2({
    target: elementRef,
...
//# sourceMappingURL=chunk-YV5EPSOR.js.map
